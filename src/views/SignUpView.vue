...
<template>
    <main>
        ...
        <div class="mt-4 flex justify-center">
            <div v-if="!success" class="mt-10 max-w-sm mx-auto">
                ...
                <form @submit.prevent="handleSubmit" class="bg-white p-4 dark:bg-slate-800 rounded-md">
                    <div class="mb-4">
                        ...
                        <input type="password" id="confirm-password" v-model="form.confirmPassword"
                            ...
                            class="dark:text-white dark:bg-slate-700 dark:paceholder-white form-input w-full rounded-md border border-gray-300 py-2 px-3 text-sm">
                    </div>
